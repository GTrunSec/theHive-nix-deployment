...
buildEnv {
  ...
  paths = [
    ...
    (fetchbower "moment" "2.29.1" "^2.24.0" "1ia5y8fzqwnc9h9rcddpcrjpdyzhl6x334q1aj5229yp9cqqy1jm")
    ...
    (fetchbower "c3" "0.4.24" "~0.4.11" "sha256-ngYSR+z/ToLTfwhkYrewjlK9mXrbJaSobuJxjHrsRuU=")
    ...
    (fetchbower "angular-page-loader" "1.2.0" "1.2.0" "sha256-16cftLIDouwtUP2IFlz6b574EZTtYtK96ZXSn4fZlww=")
